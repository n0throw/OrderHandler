...
public class ViewShipmentValidator : Validator<ViewShipment>, IViewShipmentValidator {

	public ViewShipmentValidator(string separator = "\n") : base(separator) { }
	public override bool Validate(ViewShipment obj) {
		Errors.Clear();
