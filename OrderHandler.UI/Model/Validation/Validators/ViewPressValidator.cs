...
public class ViewPressValidator : Validator<ViewPress>, IViewPressValidator {

	public ViewPressValidator(string separator = "\n") : base(separator) { }
	public override bool Validate(ViewPress obj) {
		Errors.Clear();
