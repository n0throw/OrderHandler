...
public class ViewAssemblingValidator : Validator<ViewAssembling>, IViewAssemblingValidator {

	public ViewAssemblingValidator(string separator = "\n") : base(separator) { }

	public override bool Validate(ViewAssembling obj) {
		Errors.Clear();
