...
public class ViewEdgeValidator : Validator<ViewEdge>, IViewEdgeValidator {

	public ViewEdgeValidator(string separator = "\n") : base(separator) { }
	public override bool Validate(ViewEdge obj) {
		Errors.Clear();
