...
public class ViewPacking : MainPagePropertyChanger, IDataErrorInfo {
    long _id;
    ...
    public ViewPacking() : this(new ViewPackingValidator()) {}
    
    public ViewPacking(IViewPackingValidator validator) {
        Validator = validator;
        _fio = string.Empty;
    }
